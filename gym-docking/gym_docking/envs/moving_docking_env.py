...
class MovingDockingEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.info = {'chaser': self.state_chaser,
    ...
    def step(self, action):
        ...
        action_target = self.target_controller.vel_controller(self.target_state_des, self.state_target, old_state_target)
