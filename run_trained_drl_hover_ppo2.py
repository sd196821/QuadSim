...
# plt.figure()
plt.subplot(2, 3, 3)
plt.plot(total_step, rad2deg(rpy))
...
# plt.figure()
plt.subplot(2, 3, 4)
plt.plot(total_step, rad2deg(state[:, 10:]))
plt.legend(['p', 'q', 'r'])
plt.xlabel("Time/s")
