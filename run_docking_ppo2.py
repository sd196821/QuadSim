...
if __name__ == '__main__':
    ...
    eval_callback = EvalCallback(eval_env, best_model_save_path='./logs/best_f_model',
                                 log_path='./logs/best_f_results', eval_freq=500)
`
    checkpoint_callback = CheckpointCallback(save_freq=int(5e4), save_path='./logs/',
                                             name_prefix='rl_model_621_g_10M')
    ...
    # load trained model
    # model = PPO2.load("./logs/rl_model_621_e_10M_4000000_steps.zip", env=env, tensorboard_log="./ppo2_docking_tensorboard/")
    ...
    model.save("ppo2_docking_621_g_10M")  # [b:reward_dock=10]
